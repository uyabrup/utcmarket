...
<div id = "edit-content-form" class = "edit-banner-form">
    <div id = "left"> <!-- Левая колонка -->
        <div class = "main"> <!-- Основные опции -->
            ...
            <?php print $show_edit_form_banner; ?>

            <?php print $show_edit_form_link; ?>

            <?php print $show_edit_form_ref; ?>

            <?php print $show_edit_form_ribbon; ?>

            <?php print $show_edit_form_pager; ?>

            <?php print $show_edit_form_pager_txt; ?>

            <?php print $show_edit_form_banners; ?>

            <?php print $show_edit_form_links; ?>

            <?php print $show_edit_form_other; ?>
        </div> <!-- /Основные опции -->
...
<?php print $show_edit_form_taxonomy_categories; ?> Таксономия (главные категории товаров)
...
<?php print $show_edit_form_banners; ?> Сворачивающаяся группа с полями
<?php print $show_edit_form_banner; ?> Поле изображения баннера
<?php print $show_edit_form_links; ?> Сворачивающаяся группа с полями ссылок баннера
<?php print $show_edit_form_link; ?> Ссылка баннера
<?php print $show_edit_form_ref; ?> Ссылка на связанный документ
<?php print $show_edit_form_other; ?> Сворачивающееся поле с дополнительными полями баннера
<?php print $show_edit_form_ribbon; ?> Переключатель показа строки на баннере
<?php print $show_edit_form_pager; ?> Изображение для пейджера карусели
<?php print $show_edit_form_pager_txt; ?> Текст для пейджера карусели
